defmodule MessagingService.MessagesTest do
  ...
  describe "messages" do
    ...
    test "create_message/1 with valid data creates a message" do
      valid_attrs = %{body: "some body", to: "some to", from: "some from", attachments: ["option1", "option2"]}
    ...
    test "update_message/2 with valid data updates the message" do
      message = message_fixture()
      update_attrs = %{body: "some updated body", to: "some updated to", from: "some updated from", attachments: ["option1"]}
